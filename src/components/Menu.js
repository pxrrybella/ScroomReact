    ...
    return (
        <div className="menu col-sm-3">
            <div className="mt-2 mb-5 d-flex flex-column align-items-center">
                ...
                <Link to="/Analytics"><button type="button" class="btn btn btn-dark">Ver análisis</button></Link>
            </div>
            <div className="d-flex flex-column col-m-4">
                <button type="button" class="text-sm-start btn btn-dark btn-lg m-3">Nombre Proyecto</button>
                <button type="button" class="text-sm-start btn btn-dark btn-lg m-3">Nombre Proyecto</button>
                <button type="button" class="text-sm-start btn btn-dark btn-lg m-3">Nombre Proyecto</button>
                <button type="button" class="text-sm-start btn btn-dark btn-lg m-3">Nombre Proyecto</button>
            </div>
    ...
    return (
        <div className="menu col-sm-3">
            <div className="mt-2 mb-5 d-flex flex-column align-items-center">
                ...
                <h4 class="mb-3 text-center">Nombre Proyecto</h4>
                <Link to="/IndexPage"><button type="button" class="btn btn btn-dark">Ver encuesta</button></Link>
            </div>
            <div className="d-flex flex-column col-m-4">
                <button type="button" class="text-sm-start btn btn-dark btn-lg m-3">Nombre Proyecto</button>
                <button type="button" class="text-sm-start btn btn-dark btn-lg m-3">Nombre Proyecto</button>
